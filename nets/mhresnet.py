...
class MultiHeadResNet(nn.Module):
    def __init__(self, headers, num_classes, backbone=resnet.resnet18):
...
def mhresnet18(headers, num_classes):
    return MultiHeadResNet(headers, num_classes, backbone=resnet.resnet18)

def mhresnet34(headers, num_classes):
    return MultiHeadResNet(headers, num_classes, backbone=resnet.resnet34)
